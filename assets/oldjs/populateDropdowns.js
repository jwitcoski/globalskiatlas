...
function countResorts() {
    ...
    const resortCountElement = document.createElement("p");
    resortCountElement.textContent = `Currently we have mapped ${totalResorts} skiing locations.`;
    document.querySelector(".hero-content").appendChild(resortCountElement);
}
