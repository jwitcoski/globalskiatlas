...
echo       "Parameters": {
echo         "country.$": "$$.Execution.Input.country",
echo         "resort_name.$": "$$.Execution.Input.resort_name",
echo         "params": {
echo           "limit": 50
echo         }
echo       },
...
echo       "Choices": [
echo         {
echo           "Variable": "$.queryResult.elements",
...
echo         },
echo         {
echo           "Variable": "$.queryResult.elements[0]",
echo           "IsPresent": true,
...
echo         "Payload": {
echo           "elements.$": "$.queryResult.elements"
echo         }
echo       },
...
echo.
echo To run the Step Function with a country parameter, use:
echo aws stepfunctions start-execution --state-machine-arn !STATE_MACHINE_ARN! --input "{\"country\":\"Switzerland\"}"
echo.
echo To run it with a resort name, use:
echo aws stepfunctions start-execution --state-machine-arn !STATE_MACHINE_ARN! --input "{\"country\":\"US\",\"resort_name\":\"Whitetail\"}"
echo.
echo To start the workflow with a country, use:
echo aws stepfunctions start-execution --state-machine-arn !STATE_MACHINE_ARN! --input "{\"country\":\"Switzerland\"}"
echo.
