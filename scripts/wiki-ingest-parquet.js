...
function rowToItem(row) {
  ...
  const item = {
    ...
    englishName: str(row.english_name),
    ...
    totalTrailMi: num(row.total_trail_mi),
    ...
    nightSkiing: str(row.night_skiing),
    litPistes: num(row.lit_pistes),
    litLifts: num(row.lit_lifts),
    snowmaking: str(row.snowmaking),
    ...
    phone: str(row.phone),
    elevationSource: str(row.elevation_source),
    skiNorthAngle: num(row.ski_north_angle),
    verticalDropFt: num(row.vertical_drop_ft),
